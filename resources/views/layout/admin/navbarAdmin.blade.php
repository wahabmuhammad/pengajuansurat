        ...
        <div class="container-xl">
            ...
            <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                <a href="{{route('dashboard')}}">
                    <img src="{{asset('image/jepara.png')}}" width="110" height="32" alt="Pengajuan Surat Kecamatan Welahan" class="navbar-brand-image" id="logo-jepara">
                    <span>
            ...
            <div class="navbar-nav flex-row order-md-last">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                        <span class="avatar avatar-sm" style="background-image: url({{asset('image/profile.webp')}})"></span>
                    ...
                    <div class="row flex-fill align-items-center">
                        <div class="col">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('suratpemohon.index')}}">
                                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                        </span>
                                        <span class="nav-link-title">
                                            Surat Pemohon
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('kirimsurat')}}">
                                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                                        </span>
                                        <span class="nav-link-title">
                                            Kirim Surat Pemohon
